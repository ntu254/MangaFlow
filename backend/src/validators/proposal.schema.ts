...
export const createProposalSchema = z
  .object({
    ...
    requestedPublicationType: z.enum(["WEEKLY", "MONTHLY"]).optional(),
...
export const proposalActionSchema = z.object({
  ...
  editorialChecklist: z
    .object({
      hook: z.boolean(),
      characterMotivation: z.boolean(),
      audienceFit: z.boolean(),
      storyboardFlow: z.boolean(),
      manuscriptQuality: z.boolean(),
      serializePotential: z.boolean(),
    })
    .strict()
    .optional(),
