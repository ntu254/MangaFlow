...
export const featured = [
  {
    ...
    chapters: [
      'Vol. 3 Ch. 19 – "Victory"',
      'Vol. 3 Ch. 18 – "Dependent"',
      'Vol. 3 Ch. 17 – "First Love"',
      'Vol. 3 Ch. 16 – "Comrades"',
    ],
  ...
  },
  {
    ...
    cover: gokuragukai,
    chapters: [
      'Vol. 5 Ch. 20 – "Take my Love!"',
      'Vol. 4 Ch. 19 – "Let\'s make a..."',
      'Vol. 4 Ch. 18 – "Girl Trouble"',
      'Vol. 4 Ch. 17 – "Tons of probe..."',
    ],
    tags: ["Action", "Supernatural", "Shonen", "Mystery"],
  },
  {
