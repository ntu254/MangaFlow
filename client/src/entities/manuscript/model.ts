...
export const manuscriptVersions: ManuscriptVersion[] = [
  {
    id: "mv_jojo_1",
    manuscriptId: "ms_jojo",
    version: 1,
    fileName: "sbr-v1.pdf",
    pageCount: 32,
    uploadedBy: "s_man_sano",
    uploadedAt: "Jun 04, 2026",
  ...
  },
  {
    ...
    note: "Reworked opening per Editor feedback.",
  },
  {
    id: "mv_slam_1",
    manuscriptId: "ms_slam",
    version: 1,
    fileName: "slam-v1.pdf",
    pageCount: 28,
    uploadedBy: "s_man_kei",
    uploadedAt: "Jun 12, 2026",
  },
  {
    id: "mv_grand_1",
    manuscriptId: "ms_grand",
    version: 1,
    fileName: "grand-v1.pdf",
    pageCount: 18,
    uploadedBy: "s_man_sano",
  ...
  {
    id: "mv_ghost_1",
    manuscriptId: "ms_ghost",
    version: 1,
    fileName: "ghost-v1.pdf",
    pageCount: 40,
    uploadedBy: "s_man_kei",
  ...
  {
    id: "mv_gachi_1",
    manuscriptId: "ms_gachi",
    version: 1,
    fileName: "gachi-v1.pdf",
    pageCount: 42,
    uploadedBy: "s_man_kei",
