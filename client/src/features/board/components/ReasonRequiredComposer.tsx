  ...
  return (
    <div className="space-y-2">
      <label className="flex items-center justify-between text-[11px] font-bold uppercase text-slate-500 tracking-wider">
        ...
        {isEmpty && <span className="text-rose-500 normal-case flex items-center gap-1"><AlertCircle size={12}/> Required</span>}
      </label>
      <textarea
        value={value}
        className={cn(
          ...
          isEmpty ? "border-rose-200 focus:border-rose-500 focus:ring-rose-50" : "border-slate-200 focus:border-violet-500 focus:ring-violet-50",
          className
        )}
        {...props}
      />
