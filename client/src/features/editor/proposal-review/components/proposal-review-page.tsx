...
import { useProposalQuery, useProposalActionMutation } from "@/features/proposals";
import {
  AUDIENCE_LABEL,
  STATUS_LABEL,
  type SeriesProposal,
    ...
    <div className="mx-auto min-w-0 max-w-6xl space-y-6 overflow-x-hidden p-6">
      ...
      <div className="grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1.4fr)_minmax(280px,1fr)]">
        ...
        <aside className="min-w-0 space-y-4">
          ...
          <EditorialChecklist proposalId={proposal.id} />
...
function FileAssetRow({ title, meta, href }: { title: string; meta?: string; href?: string }) {
