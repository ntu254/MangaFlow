import { MousePointer2, Square, MessageSquare, Hand, ZoomIn, Sparkles, Undo2, Redo2, ChevronDown } from 'lucide-react'

export function PageWorkspaceToolbar() {
  return (
    <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 shrink-0 overflow-x-auto [&::-webkit-scrollbar]:hidden">
      ...
      <div className="flex items-center gap-3 shrink-0 ml-4">
        <button type="button" className="flex items-center gap-2 px-3 py-1.5 bg-purple-50 text-purple-700 border border-purple-100 rounded-lg text-[12px] font-bold hover:bg-purple-100 transition-colors">
          <Sparkles size={14} /> AI Detect
        </button>
...
function ToolBtn({ icon, label, active }: any) {
  return (
