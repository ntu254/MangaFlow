...
import { Wallet, CheckCircle2, AlertCircle, Loader2, RefreshCw, Search } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-3.5rem)] bg-[#fff9fb]">
      <div className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-[#2f243a]">Payroll Overview</h1>
            <p className="mt-1.5 text-sm text-[#8a7a99]">
