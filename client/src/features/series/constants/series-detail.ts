export const seriesDetailStats = {
  ...
  health: {
    ...
    workload: { label: "Workload", status: "Moderate", value: 60, color: "bg-orange-500", iconText: "text-orange-500" },
  ...
  chapterSummary: {
    ...
    distribution: [
      ...
      { status: "Editor Review", value: 2, color: "bg-orange-500" },
  ...
  nextActions: [
    ...
    { id: 4, title: "Board review", description: "Chapter 10", due: "Due in 2 days", type: "board", iconColor: "text-orange-600 bg-orange-50" },
  ...
  recentActivity: [
    ...
    { id: 4, text: "Board review completed", time: "Yesterday, 2:00 PM", icon: "file", color: "text-orange-600 bg-orange-100" }
  ]
};
