        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: APP_ROUTES.admin.series.replace(/^\/app\//, ""), element: <Suspense fallback={null}><LazyAdminSeriesPlaceholder /></Suspense> },
              { path: APP_ROUTES.admin.taskTypes.replace(/^\/app\//, ""), element: <Suspense fallback={null}><LazyAdminTaskTypesPlaceholder /></Suspense> },
