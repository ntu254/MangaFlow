        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: APP_ROUTES.mangaka.chapters.replace(/^\/app\//, ""), element: <LazySeriesPage /> },
              { path: APP_ROUTES.mangaka.tasks.replace(/^\/app\//, ""), element: <LazyTasksPage /> },
              { path: APP_ROUTES.mangaka.submissions.replace(/^\/app\//, ""), element: <LazyReviewPage /> },
              { path: APP_ROUTES.mangaka.comments.replace(/^\/app\//, ""), element: <LazyReviewPage /> },
          ...
          },
          {
            ...
            children: [
              ...
              { path: APP_ROUTES.editor.manuscripts.replace(/^\/app\//, ""), element: <LazyReviewPage /> },
              { path: APP_ROUTES.editor.chapters.replace(/^\/app\//, ""), element: <LazySeriesPage /> },
              { path: APP_ROUTES.editor.pages.replace(/^\/app\//, ""), element: <LazySeriesPage /> },
              { path: APP_ROUTES.editor.comments.replace(/^\/app\//, ""), element: <LazyReviewPage /> },
