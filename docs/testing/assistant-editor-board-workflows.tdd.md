...
| Archiving one notification preserves the rest of the inbox   | `business-flow-contracts.spec.ts`                        | Missing export RED for archive cache helper            | Only the selected notification ID receives `archivedAt`                                    |
