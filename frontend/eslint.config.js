...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // React Hooks 7 enables the React Compiler diagnostics by default. The
      // existing app intentionally uses effect-driven pagination/selection and
      // hand-authored memoization; keep those diagnostics opt-in until their
      // dedicated migration is planned instead of making this dependency bump
      // change runtime behavior across unrelated screens.
