...
> = {
  ...
  PENDING_EDITOR: {
    ...
    stage: "Editor review",
    nextAction: "Waiting for editor review",
    ctaLabel: "View Status",
  },
  EDITOR_REVIEWING: {
    ...
    pillClass:
      "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-900/50",
    stage: "Editor reviewing",
    nextAction: "Editor is reviewing",
    ctaLabel: "View Status",
  },
  CHANGES_REQUESTED: {
