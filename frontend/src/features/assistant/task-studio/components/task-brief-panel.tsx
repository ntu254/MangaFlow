...
export function TaskBriefPanel({
  ...
  const checklist = [
    "Follow the marked region boundaries",
    "Maintain proportions and style from previous chapters",
    "Ensure output file is in the correct format",
  ];
  return (
    <aside className="flex h-full flex-col gap-4 overflow-y-auto p-3">
      ...
      <Header icon={<Layers className="size-3.5" />} title="Region area" />
