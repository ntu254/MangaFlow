            ...
            <Tooltip>
              ...
              <TooltipContent>
                {canSubmitWork
                  ...
                  : submitWorkLabel === "Awaiting Review"
                    ? "The latest submission is waiting for Mangaka review"
                    : submitWorkLabel === "Reopen to Revise"
                      ? "Reopen the task before submitting a revised version"
                      : submitWorkLabel === "Submission Closed"
                        ? "This task no longer accepts submissions"
                        : "Select an in-progress assigned task"}
              </TooltipContent>
            </Tooltip>
          </>
        ) : null}
