        ...
        >
          ...
          >
            ...
            <p className="mb-3 text-xs text-muted-foreground">
              Enter the email of an assistant with an existing account. Only the <b>assistant</b>{" "}
              role can be invited.
            </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-80 rounded-md border border-border bg-card p-4 shadow-lg">
            ...
            {tantouEditor ? (
              ...
              <p className="mb-3 text-xs text-muted-foreground">
                No Tantou Editor assigned. Select an editor from the list below.
              </p>
            )}
            <div className="mb-3">
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col rounded-md border border-border bg-card xl:w-[280px]">
      <div className="flex-1 overflow-y-auto p-3">
        ...
        <p className="mt-1 text-[10px] text-muted-foreground">Joined {member.joined}</p>
