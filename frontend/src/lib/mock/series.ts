...
export const seedSeries: ProductionSeries[] = [
  ...
  },
  {
    ...
    synopsis: "Continuing Thorfinn's journey in new lands.",
  ...
  },
  {
    ...
    synopsis: "A few concluding chapters wrapping up Tenma's journey.",
...
export const seedChapters: Chapter[] = [
  ...
  makeChapter("s-berserk-prod", 1, "The Beginning of Darkness", "PUBLISHED", {
    publishedAt: iso(-60),
    scheduledAt: iso(-60),
  }),
  makeChapter("s-berserk-prod", 2, "The Nameless Blade", "PUBLISHED", {
    publishedAt: iso(-46),
    scheduledAt: iso(-46),
  }),
  makeChapter("s-berserk-prod", 3, "Old Wounds", "PUBLISHED", {
    publishedAt: iso(-32),
    scheduledAt: iso(-32),
  }),
  makeChapter("s-berserk-prod", 4, "Echoes", "READY_FOR_PUBLICATION", {
    scheduledAt: iso(3),
    publication: {
      id: "pub-ch-s-berserk-prod-4",
  ...
  makeChapter("s-berserk-prod", 5, "The Last Moonlight", "TANTOU_REVIEW", {
    reviewDueAt: iso(2),
    reviewNotes: [
      {
        ...
        authorRole: "editor",
        text: "Panel 3, page 12: layout loses rhythm, review spacing between speech bubbles.",
        resolved: false,
        createdAt: iso(-1),
      },
      {
        ...
        authorRole: "board",
        text: "Color tone in the ending is too dark, consider adding more highlights.",
        resolved: true,
        createdAt: iso(-3),
      },
    ],
  }),
  makeChapter("s-berserk-prod", 6, "The Heroic Elegy", "IN_PRODUCTION", {
    draftDueAt: iso(5),
  ...
  makeChapter("s-vinland-prod", 1, "The New Harbor", "PUBLISHED", {
    publishedAt: iso(-30),
    scheduledAt: iso(-30),
  ...
  makeChapter("s-vinland-prod", 3, "The Cold Sun", "READY_FOR_PUBLICATION", {
    scheduledAt: iso(5),
    publication: {
      id: "pub-ch-s-vinland-prod-3",
      seriesId: "s-vinland-prod",
      chapterId: "ch-s-vinland-prod-3",
      status: "SCHEDULED",
      scheduledAt: iso(5),
    },
  ...
  makeChapter("s-vinland-prod", 4, "Stranger in the Forest", "READY_FOR_PUBLICATION", {
    ...
    reviewNotes: [
      {
        ...
        authorName: "Tanaka Akira",
        authorRole: "editor",
        text: "Adjusted lettering on page 14 as requested.",
        resolved: true,
        createdAt: iso(-5),
      },
    ],
  }),
  makeChapter("s-vinland-prod", 5, "White Night", "TANTOU_REVIEW", {
    reviewDueAt: iso(3),
    pages: Array.from({ length: 22 }, (_, i) => ({
    ...
    reviewNotes: [
      {
        ...
        authorName: "Tanaka Akira",
        authorRole: "editor",
        text: "Pages 08-09: action is not seamless, need to insert an additional reaction panel.",
        resolved: false,
        createdAt: iso(-1),
      },
      {
        ...
        text: "Fixed font for SFX 'crash' on page 15.",
        resolved: true,
        createdAt: iso(-2),
      },
    ],
  }),
  makeChapter("s-vinland-prod", 6, "Old Scars", "REVISION_REQUIRED", {
    draftDueAt: iso(6),
    revisionRound: 1,
    ...
    reviewNotes: [
      {
        ...
        authorName: "Tanaka Akira",
        authorRole: "editor",
        text: "Battle scene on page 04 needs additional background layers for depth.",
        resolved: false,
        createdAt: iso(-2),
      },
    ],
  }),
  makeChapter("s-vinland-prod", 7, "Call of the North Wind", "IN_PRODUCTION", {
    draftDueAt: iso(4),
  ...
  makeChapter("s-vinland-prod", 8, "The Unnamed Horizon", "PLANNED", {
    draftDueAt: iso(20),
  }),
  // Monster Epilogue
  makeChapter("s-monster-prod", 1, "Prologue", "PUBLISHED", { publishedAt: iso(-200) }),
