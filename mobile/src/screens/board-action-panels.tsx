    ...
    <MFCard>
      ...
      <View style={styles.finalizeBlock}>
        ...
        <MFButton
          style={styles.actionButtonFull}
          onPress={onFinalize}
          disabled={item.voteSummary.canFinalize === false}
        >
    ...
    <MFCard>
      ...
      <View style={styles.actionButtons}>
        <MFButton
          ...
          variant="soft"
          style={styles.actionButtonHalf}
          onPress={() => onStartDecision("CONTINUE")}
        >
          Continue
        </MFButton>
        <MFButton
          ...
          variant="soft"
          style={styles.actionButtonHalf}
          onPress={() => onStartDecision("WARNING")}
        >
          Warning
        </MFButton>
        <MFButton
        ...
        <MFButton
          ...
          variant="soft"
          style={styles.actionButtonHalf}
          onPress={() => onStartDecision("CANCEL")}
        >
          Cancel
        </MFButton>
      </View>
...
export function BoardVoteCount({
  label,
  value,
  tone,
}: {
