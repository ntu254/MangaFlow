...
describe("admin user service", () => {
    beforeEach(() => {
        ...
        toAuthUser.mockImplementation((id) => Promise.resolve({ id, email: "user@example.com", name: "User", role: "MANGAKA", isActive: true }));
    });
...
//# sourceMappingURL=admin-user.service.test.js.map