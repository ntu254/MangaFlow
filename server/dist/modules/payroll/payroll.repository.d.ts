...
export declare function updateEarningStatus(earningId: string, status: AssistantEarningStatus, actorField: "confirmedBy" | "paidBy", actorId: string): Promise<(import("mongoose").Document<unknown, {}, import("./payroll.model.js").AssistantEarningDocument, {}, {}> & import("./payroll.model.js").AssistantEarningDocument & Required<{
    _id: import("mongoose").Types.ObjectId;
}> & {
    __v: number;
}) | null>;
