...
import { addSeriesMember, listSeriesMembers, updateSeriesMember, removeSeriesMember, getEligibleAssistants, } from "./series-member.controller.js";
const router = Router();
...
router.post("/:seriesId/manuscripts/uploads", requireAuth, requireRole("MANGAKA"), validate(seriesIdParamsSchema, "params"), validate(createManuscriptUploadSchema), asyncHandler(controller.createManuscriptUpload));
router.patch("/:seriesId", requireAuth, requireRole("MANGAKA"), validate(seriesIdParamsSchema, "params"), validate(updateSeriesSchema), asyncHandler(controller.updateSeries));
