...
import { createSubmissionBodySchema, reviewActionBodySchema, submissionIdParamsSchema, taskIdParamsSchema, getTaskUploadUrlBodySchema, } from "./submission.validation.js";
const router = Router();
...
router.post("/tasks/:taskId/submissions/upload-url", requireAuth, validate(taskIdParamsSchema, "params"), validate(getTaskUploadUrlBodySchema), controller.getTaskUploadUrl);
