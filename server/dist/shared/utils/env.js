...
function readEnv(source, key, fallback) {
...
function optionalEnv(source, key) {
    const value = source[key];
    return value && value.trim() ? value : undefined;
}
function requireProductionEnv(source, key) {
...
function requireProductionSecret(source, key) {
