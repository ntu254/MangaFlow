...
describe("buildConfig", () => {
    ...
    it("rejects missing production auth secrets", () => {
        expect(() => buildConfig(productionEnv({ JWT_ACCESS_SECRET: undefined }))).toThrow("JWT_ACCESS_SECRET");
    });
    it("rejects weak production auth secrets", () => {
        expect(() => buildConfig(productionEnv({ JWT_ACCESS_SECRET: "short-secret" }))).toThrow("strong secret");
    });
