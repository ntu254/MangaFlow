...
describe("admin task type service", () => {
  ...
  it("updates editable task type fields", async () => {
    updateTaskType.mockResolvedValue({ name: "Lettering", description: "Updated", baseRate: 150 })

    await expect(service.updateAdminTaskTypeService("type1", { description: "Updated", baseRate: 150 }))
      .resolves.toMatchObject({ description: "Updated", baseRate: 150 })
  })
