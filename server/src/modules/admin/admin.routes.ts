...
router.patch("/users/:userId", validate(adminUserIdParamsSchema, "params"), validate(adminUpdateUserSchema), controller.updateAdminUser)
router.delete("/users/:userId", validate(adminUserIdParamsSchema, "params"), controller.deleteAdminUser)
