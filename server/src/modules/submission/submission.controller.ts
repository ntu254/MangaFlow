...
export async function listTaskSubmissions(
  ...
  const submissions = await listTaskSubmissionsService(
...
export async function mangakaApproveSubmission(
  req: Request,
  res: Response,
  _next: NextFunction,
): Promise<void> {
  ...
  res.json({
    success: true,
    message: "Submission approved by Mangaka",
    data: submission,
  })
}
...
export async function requestSubmissionRevision(
  ...
  res.json({
    success: true,
    message: "Submission revision requested",
    data: submission,
  })
}
...
export async function editorApproveSubmission(
  req: Request,
  res: Response,
  _next: NextFunction,
): Promise<void> {
  ...
  res.json({
    success: true,
    message: "Submission final-approved by Editor",
    data: submission,
  })
}
