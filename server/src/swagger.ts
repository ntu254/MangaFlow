...
const schemas = {
  ...
  ManuscriptUploadRequest: {
    ...
    properties: {
      ...
      assetType: { type: "string", enum: ["manuscript", "cover_draft", "character_concept", "reference_image", "other"] },
      slot: { type: "string" },
    },
  },
  ...
  AtRiskDecisionRequest: {
    type: "object",
    required: ["decision"],
    properties: { decision: { type: "string", enum: ["CONTINUE", "WARNING", "CANCEL", "COMPLETE"] }, note: { type: "string" } },
  },
  ...
  UpdateChapterStatusRequest: { type: "object", required: ["status"], properties: { status: { type: "string", enum: ["DRAFT", "IN_PRODUCTION", "READY_FOR_PUBLICATION", "PUBLISHED", "ARCHIVED"] } } },
  ...
  UpdateRegionStatusRequest: { type: "object", required: ["status"], properties: { status: { type: "string", enum: ["ACTIVE", "LOCKED", "DELETED"] } } },
  CreateTaskRequest: {
    type: "object",
  ...
  UpdateTaskStatusRequest: { type: "object", required: ["status"], properties: { status: { type: "string", enum: ["TODO", "IN_PROGRESS", "SUBMITTED", "REVISION_REQUESTED", "MANGAKA_APPROVED", "EDITOR_APPROVED", "REJECTED", "CANCELLED"] } } },
