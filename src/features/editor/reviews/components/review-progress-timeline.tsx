...
const STAGES: Stage[] = [
  {
    key: "mangaka",
    label: "Mangaka Review",
    icon: UserCheck,
    match: (e) => e.toStatus === "MANGAKA_REVIEW" || e.type === "START_ASSISTANT_WORK",
  },
  {
    key: "editor",
    label: "Editor Review",
    icon: FileText,
    match: (e) => e.toStatus === "EDITOR_REVIEW" || e.type === "SUBMIT_REVIEW",
  },
  {
    key: "revision",
    label: "Revision",
    icon: PenTool,
    match: (e) => e.toStatus === "REVISION" || e.type === "REQUEST_REVISION",
  },
  { key: "resubmit", label: "Resubmitted", icon: Upload, match: (e) => e.type === "RESUBMIT" },
  {
    ...
    label: "Approved",
    icon: Check,
    match: (e) => e.toStatus === "EDITOR_APPROVED" || e.type === "EDITOR_APPROVE",
  },
];
